...
export default function (options = {}) {
  ...
  return {
    ...
    generateBundle: async function (...args) {
        ...
        reporter: (options, bundle, { fileName, bundleSize, minSize, gzipSize, brotliSize }) => {
          ...
          const entry = {
            ...
            Size: getReadableSize({
              value: calculateByteSize(bundleSize),
              ...defaultOptions,
            }),
          };
          ...
          if (defaultOptions.showMinifiedSize) {
            ...
            entry.Minified = getReadableSize({
              value: calculateByteSize(minSize),
              ...defaultOptions,
            });
          }
          if (defaultOptions.showGzippedSize) {
            totalGzipped += calculateByteSize(gzipSize);
            entry.Gzipped = getReadableSize({
              value: calculateByteSize(gzipSize),
              ...defaultOptions,
            });
          }
          if (defaultOptions.showBrotliSize) {
            totalBrotli += calculateByteSize(brotliSize);
            entry.Brotli = getReadableSize({
              value: calculateByteSize(brotliSize),
              ...defaultOptions,
            });
          }
      ...
      if (defaultOptions.showMinifiedSize) {
        columnsMaxValue.Minified = getReadableSize({
          value: totalMinified,
          isTotal: true,
          ...defaultOptions,
          colored: false,
      ...
      if (defaultOptions.showGzippedSize) {
        columnsMaxValue.Gzipped = getReadableSize({
          value: totalGzipped,
          isTotal: true,
          ...defaultOptions,
          colored: false,
      ...
      if (defaultOptions.showBrotliSize) {
        columnsMaxValue.Brotli = getReadableSize({
          value: totalBrotli,
          isTotal: true,
          ...defaultOptions,
          colored: false,
      ...
      if (defaultOptions.showMinifiedSize) {
        ...
        totals.Minified = getReadableSize({
          value: totalMinified,
          isTotal: true,
          ...defaultOptions,
        });
      ...
      if (defaultOptions.showGzippedSize) {
        ...
        totals.Gzipped = getReadableSize({
          value: totalGzipped,
          isTotal: true,
          ...defaultOptions,
        });
