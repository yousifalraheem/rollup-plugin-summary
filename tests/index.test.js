...
/**
 * @param {Array<import('rollup-plugin-filesize').FileSizeInfo>} reports 
 * @returns {any}
 */
const setup = (reports) => {
    filesize.mockImplementation((/** @type {import('rollup-plugin-filesize').FileSizePluginOptions} */ options) => {
